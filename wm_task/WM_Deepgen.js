...
function setup_jsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of setup_jsComponents)
...
function repeat_pracLoopBegin(repeat_pracLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisRepeat_prac of repeat_prac) {
...
function demo_prac_taskLoopBegin(demo_prac_taskLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisDemo_prac_task of demo_prac_task) {
...
function Instructions6bRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instructions6bComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function memorandaRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of memorandaComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function correct_ansRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of correct_ansComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function repeat_codeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of repeat_codeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function intro_txtRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of intro_txtComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function initial_waitRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of initial_waitComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function reliability_cueRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of reliability_cueComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function pingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of pingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function noise_maskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of noise_maskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function repeat_practice_codeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of repeat_practice_codeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function image_recall_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of image_recall_taskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function small_breakRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of small_breakComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
